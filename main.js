...
async function getCode1() {
  var dbx = new Dropbox.Dropbox({ clientId: CLIENT_ID });
  var token = dbx.auth.getAccessTokenFromCode('http://localhost:8000/', '1gRsak2RXjAAAAAAAAAAKNvp5YGs-Lw94amAs2GEVg8');
...
async function getCode() {
  ...
  //const response1 = await fetch('https://www.dropbox.com/oauth2/authorize?client_id=kj5lj89k7br0v46&token_access_type=offline&response_type=code');
...
async function getRefreshToken() {
  ...
  const response = await fetch('https://api.dropbox.com/oauth2/token', {
    ...
    body: new URLSearchParams({
      "code": "1gRsak2RXjAAAAAAAAAAKelnToMXv9mV4S_6eO8Q3lQ",
